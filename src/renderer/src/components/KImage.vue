<template>
  <div class="KImage">
    <img class="pic" v-show="valid" :src="url" @load="valid=true" @error="valid=false" />
    <svg class="alt" v-show="!valid" viewBox="0 0 1024 1024">
...
@mixin k-img-child($t: 0, $l: 0, $h: 100%, $w: 100%) {
  position: absolute;
  top: $t;
  left: $l;
  height: $h;
